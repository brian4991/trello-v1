      ...
      <Dialog
       ...
       onClose={closeModal}>
        ...
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xm bg-white p-6 text-left align-middle shadow-xl transition-all">
            <Dialog.Title
              as="h3"
              ...
              text-sm font-medium fext-blue-900 hover:bg-blue-200 focus:outline-none focus-visible:ring-2 
